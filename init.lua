...
-- textwidth will break the line when it reaches the specified width with <EOL>
...
-- [[ Autocommands for cursor staying centered ]]
...
local stay_centered_group = vim.api.nvim_create_augroup('stay_centered', { clear = true })
